...
public class mail {
    ...
    public static void startMailAutomation(final int id, final String table_user, final String table_pass, final String table_proxy2) {
    ...
    public static void prePareRowsHelper1() {
        SwingWorker<Void, Void> email = new SwingWorker<Void, Void>() {
    ...
    public static void prePareRowsHelper2() {
        SwingWorker<Void, Void> email = new SwingWorker<Void, Void>() {
    ...
    public static void prePareRowsHelper3() {
        SwingWorker<Void, Void> email = new SwingWorker<Void, Void>() {
            ...
            protected Void doInBackground() throws Exception {
                ...
                try {
                    ...
                    for (f_i = f_i; f_i < f2_i; f_i++) {
                        ...
                        startMailAutomation((id_int), user.toString(), pass.toString(), proxy.toString());
